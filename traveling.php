					...
					<div class="col-md-12">
					    <div class="article">
					        <a class="blog-img">
							    ...
							    <div class="link">
								<span class="read">Paluang Cliff</h2>
							    </div>
							</a>
							<div class="desc">
					...
					<div class="col-md-12">
						<div class="article">
							<a href="blog.html" class="blog-img">
								...
								<div class="overlay"></div>
								<div class="link">
									<span class="read">Klingking Beach</h2>
								</div>
							</a>
							<div class="desc">
								<span class="meta">15, Feb 2018</span>
								<h2><a href="blog.html">Klingking Beach</a></h2>
								<p>When she reached the first hills of the Italic Mountains, she had a last view back on the skyline of her hometown Bookmarksgrove</p>
							</div>
						</div>
					</div>
					...
					<div class="col-md-12">
						<div class="article">
							<a href="blog.html" class="blog-img">
								...
								<div class="overlay"></div>
								<div class="link">
									<span class="read">Broken Beach</h2>
								</div>
							</a>
							<div class="desc">
								<span class="meta">15, Feb 2018</span>
								<h2><a href="blog.html">Broken Beach</a></h2>
								<p>When she reached the first hills of the Italic Mountains, she had a last view back on the skyline of her hometown Bookmarksgrove</p>
							</div>
						</div>
					</div>
